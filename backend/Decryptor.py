"""Decrypt FindMy location report payloads.

Vendored verbatim from MatthewKuKanich/FindMyFlipper (AirTagGeneration/Decryptor.py).
The ECIES-style scheme is copied from openhaystack-python (thanks @hatomist).
"""
import hashlib
